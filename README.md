...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0nhf-2g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0nhf-2g.containers.anotherwebservice.com/
...
```
git clone git@github.com:Shrey-Naithani/container-0nhf-2g.git
cd container-0nhf-2g
```
...
```
docker attach container-0nhf-2g
```
